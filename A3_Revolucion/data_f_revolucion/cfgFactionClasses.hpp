class CfgFactionClasses
{
	...
	class Revolucion_OPF_F_F 										// FASR
	{
		displayName = $STR_A3_R_CfgFactionClasses_OPF_F_F0;
		priority = 3;
		side = TEast;
		icon = "\A3_Revolucion\Data_F_Revolucion\FactionIcons\CfgFactionClasses_OPF_F_CA.paa";		
