/* FRR BLUFOR */
class Rev_B_FRR_Boat_Transport_01_F: B_G_Boat_Transport_01_F
{
    side = TWest;
...
/* FRR INDEP */
class Rev_I_FRR_Boat_Transport_01_F: B_G_Boat_Transport_01_F
{
    side = TGuerrila;
...
/* FRR OPFOR */
class Rev_O_FRR_Boat_Transport_01_F: B_G_Boat_Transport_01_F
{
    side = TEast;
