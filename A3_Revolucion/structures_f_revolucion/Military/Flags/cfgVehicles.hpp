class CfgVehicles
{
	...
	class Flag_BDF_F: FlagCarrier
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) setFlagTexture '\A3_Revolucion\Data_F_Revolucion\Flags\flag_BDF_CO.paa'";
		};
	};
	class Flag_FASR_F: FlagCarrier
	{
		author = $STR_A3_A_BranFlakes;
		class SimpleObject
		{
	...
	class Flag_PNB_F: FlagCarrier
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) setFlagTexture '\A3_Revolucion\Data_F_Revolucion\Flags\flag_PNB_CO.paa'";
		};
	};
};