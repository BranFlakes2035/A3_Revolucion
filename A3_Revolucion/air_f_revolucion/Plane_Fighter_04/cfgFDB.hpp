class rev_B_Plane_Fighter_04_F: Plane_Fighter_04_Base_F
{
	...
	crew = rev_B_BDF_Fighter_Pilot_F;
	typicalCargo[] = {rev_B_BDF_Fighter_Pilot_F};
	textureList[] = {BDF,1};
	...
	{
		EjectionSeatClass = rev_B_Ejection_Seat_Plane_Fighter_04_F;
	};
};
class rev_B_Ejection_Seat_Plane_Fighter_04_F: Ejection_Seat_Plane_Fighter_04_base_F
{
	class SimpleObject
	{
		eden = false;
	...
	scope = protected;
	side = TWest;
	faction = rev_B_BDF_Fighter_Pilot_F;
	crew = rev_B_BDF_Fighter_Pilot_F;
};